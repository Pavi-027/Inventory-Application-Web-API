...
{
    /// <inheritdoc />
    public partial class initialMigrationOfAddingAllTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalQuantityOfProduct = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCostOfSalesOrder = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCostOfPurchaseorder = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSalesOrder", x => new { x.ProductsProductId, x.SalesId });
                    table.ForeignKey(
                        name: "FK_ProductSalesOrder_Products_ProductsProductId",
                        column: x => x.ProductsProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSalesOrder_SalesOrders_SalesId",
                        column: x => x.SalesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPurchaseOrder", x => new { x.ProductsProductId, x.PurchaseId });
                    table.ForeignKey(
                        name: "FK_ProductPurchaseOrder_Products_ProductsProductId",
                        column: x => x.ProductsProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseOrder_PurchaseOrders_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseOrder_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSalesOrder_SalesId",
